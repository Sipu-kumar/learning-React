...
function Card({username, btntext="Click me"}){ //if btntext prop is not passed then it will take default value "Click me"...
    // console.log(props.username);
  return (
    <>
    <div class="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
        <h5 class="mb-3 text-2xl font-semibold tracking-tight text-heading leading-8">This is my {username}</h5>
        ...
        <button class="ms-4 px-4 py-2 bg-green-500 text-black rounded-lg hover:bg-green-700">{btntext}</button>
    </div>
